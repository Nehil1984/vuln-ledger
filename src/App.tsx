    ...
    <div className="layout">
      ...
      <main className="main">
        ...
        <footer className="app-footer">
          ...
          <a className="app-footer__link" href="https://www.apache.org/licenses/LICENSE-2.0" target="_blank" rel="noreferrer">Apache License 2.0 lesen</a>
        </footer>
      </main>
    </div>
  )
