    ...
    <div className="layout">
      ...
      <main className="main">
        ...
        <footer className="app-footer">
          ...
          <div className="app-footer__link">Lizenz und Copyright</div>
        </footer>
      </main>
    </div>
  )
