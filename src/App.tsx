...
const navItems = [
  ...
  { to: '/license', label: 'Lizenz', hint: 'Apache 2.0' },
  { to: '/admin', label: 'Admin', hint: 'User, DB, Backup' },
]
  ...
  return (
    <div className="layout">
      ...
      <main className="main">{notice ? <div className="success-box">{notice}</div> : null}
        ...
        <footer className="app-footer">VulnLedger · Version {APP_VERSION} · Apache-2.0 · Copyright [2026] [Daniel Schuh]</footer>
      </main>
    </div>
  )
}
...
function LicensePage() {
  return <><PageHeader eyebrow="Lizenz" title="Lizenztext, Apache License 2.0" meta={`Version ${APP_VERSION} · aktueller Lizenztext der Anwendung`} /><section className="panel-grid"><article className="panel panel--license"><div className="panel__header"><h2>Lizenztext, Apache License 2.0</h2><span>Aktueller Lizenztext der Anwendung in Markdown-Form.</span></div><pre className="license-text">{licenseText}</pre></article></section></>
}
